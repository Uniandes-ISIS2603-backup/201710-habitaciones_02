...
/**
    ...
    @Test
    public void findResenasPorHabitacion()
    {
        List<ResenaEntity> lista;
    ...
    @Test
    public void findResenasPorViajeroYRangoUno()
    {
        
        try 
        {
            List<ResenaEntity> lista;
            lista = logic.finResenasViajeroPorRango(dataViajero.get(0).getIdUsuario(),
    ...
    @Test
    public void findResenasPorViajeroYRangoDos()
    {
        try 
        {
    ...
    @Test
    public void findResenasPorHabitacionYRangoUno()
    {
        try 
        {
            List<ResenaEntity> lista;
            lista = logic.finResenasHabitacionPorRango(dataHabitacion.get(0).getId(),
                    CALIFICACION_MENOR,CALIFICACION_MAYOR);
    ...
    @Test
    public void findResenasPorHabitacionYRangoDos()
    {
        try 
        {
    ...
    public void updateResenaUno()
    {
        try 
        {
            ...
            entityUp.setViajero(dataViajero.get(0));
    ...
    public void updateResenaTres()
    {
        try 
        {
            ...
            entityUp.setId(entity.getId());
            entityUp.setViajero(null);
            entityUp.setHabitacion(null);
            entityUp.setCalificacion(3.0);
